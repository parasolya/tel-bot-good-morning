...
const topic = 'Згенерувати мотивуюче ранкове повідомлення для співробітників з побажанням чудового настрою, продуктивного дня та досягнення робочих цілей українською мовою.'

bot.start((ctx) => {
  console.log("Received /start command from user.");
  ctx.reply("Welcome! Use /generate <topic> to create a new post or wait for scheduled posts.")
});
